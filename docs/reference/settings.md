...
| `skills.enabled` | `[]string` | Registry skills offered/defaulted in `forge init` (the wizard offers only these; non-interactive `--skills` is gated). Empty = all registry skills |
